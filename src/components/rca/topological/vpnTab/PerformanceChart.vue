...
const CPURateParams = reactive({
  ...
  info: {
    data: [
      { time: '10:17', type: '159.226.14.82-cpu使用率', value: 10 },
      { time: '10:19', type: '159.226.14.82-cpu使用率', value: 12 },
      { time: '10:21', type: '159.226.14.82-cpu使用率', value: 12 },
      { time: '10:23', type: '159.226.14.82-cpu使用率', value: 17 },
      { time: '10:25', type: '159.226.14.82-cpu使用率', value: 17 },
      { time: '10:27', type: '159.226.14.82-cpu使用率', value: 11 },
      { time: '10:29', type: '159.226.14.82-cpu使用率', value: 11 },
      { time: '10:31', type: '159.226.14.82-cpu使用率', value: 12 },
      { time: '10:33', type: '159.226.14.82-cpu使用率', value: 12 },
      { time: '10:35', type: '159.226.14.82-cpu使用率', value: 17 },
      { time: '10:37', type: '159.226.14.82-cpu使用率', value: 17 },
      { time: '10:39', type: '159.226.14.82-cpu使用率', value: 11 }
    ],
    chart: {
      position: 'time*value',
      padding: [15, 20, 60, 30],
